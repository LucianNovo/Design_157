  ...
  // Creating the orbit
      ...
      function loop(){
          ...
          for(var c=0; c < clusters.length; c++){
            ...
            for(var p=1; p < clusters[c].clusterPlanets.length; p++){
              ...
              // var kuler  = ["0x14A697", "0xF2C12E", "0xF29D35", "0xF27649", "0xF25252"];
              planetRef.sphere.material.color.setHex(["0x14A697", "0xF2C12E", "0xF29D35", "0xF27649", "0xF25252"][c]);
      ...
      function onDocumentMouseDown( event ) {
        ...
        var vector = d( ( event.clientX / window.innerWidth ) * 2 - 1, - ( event.clientY / window.innerHeight ) * 2 + 1, 0.5 );
